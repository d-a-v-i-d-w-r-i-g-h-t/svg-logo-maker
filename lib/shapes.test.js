...
describe('Shapes - Circle', () => {
  ...
  // A test is created to check that the SVG shape data includes the proper rendered color.
  describe('SVG rendered shape color', () => {
    it('should return a string containing fill="blue"', () => {

      // Arrange
      const shapeColor = "blue";
      const renderedColor = 'fill="blue"'

      // Act
      const shape = new Circle( shapeColor );
      const svgData = shape.shapeLine();

      // Assert
      expect(svgData).toContain(renderedColor);
